#  nohup bash ./scripts/Llama/Llama3/flucdc_south.sh > ./Output/SouthChinaFlu/Llama3_relu.log 2>&1 &
...
python main.py \
    ...
    --model_id flu+%_in_SouthChina_$model'_'$llama_layer'_'$seq_len'_'$pred_len'_'$percent \
    --data custom \
    --seq_len $seq_len \
    --label_len 18 \
    --pred_len $pred_len \
