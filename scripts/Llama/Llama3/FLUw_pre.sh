#  nohup bash ./scripts/Llama/Llama3/FLUw_pre.sh > ./Output/Weekly/Llama3_relu.log 2>&1 &
    ...
    for fix_seed in 2021 2024 42; do
        ...
        for if_inverse in 0 2; do
            python main.py \
                ...
                --model_id Flu_Weekly_pre_$model'_'$llama_layer'_'$seq_len'_'$pred_len'_'$percent \
                --data custom \
                --seq_len $seq_len \
                --label_len 18 \
                --pred_len $pred_len \
