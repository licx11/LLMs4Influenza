#  nohup bash ./scripts/Llama/ili_south.sh > ./Output/SouthChinaILI/Llama2_relu_lr4_predlen8.log 2>&1 &

#  nohup bash ./scripts/Llama/ili_south.sh > ./Output/SouthChinaILI/Llama2_relu_before_52.log 2>&1 &
